...
VertexShader* GraphicsEngine::createVertexShader(const void* shader_byte_code, size_t bye_code_size)
{
	...
	if (!vs->init(shader_byte_code, bye_code_size))
	{
		vs->release();
		return nullptr;
	}
...
PixelShader* GraphicsEngine::createPixelShader(const void* shader_byte_code, size_t bye_code_size)
{
	PixelShader* ps = new PixelShader();

	if (!ps->init(shader_byte_code, bye_code_size))
	{
		ps->release();
		return nullptr;
	}
