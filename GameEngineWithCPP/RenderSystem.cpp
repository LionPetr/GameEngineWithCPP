...
DeviceContextPtr RenderSystem::getImmidiateDeviceContext()
{
...
VertexShaderPtr RenderSystem::createVertexShader(const void* shader_byte_code, size_t bye_code_size)
{
	VertexShaderPtr vs = nullptr;
	try
	{
		vs = std::make_shared<VertexShader>(shader_byte_code, bye_code_size, this);
	}
	catch (...) {}
	return vs;
}
...
PixelShaderPtr RenderSystem::createPixelShader(const void* shader_byte_code, size_t bye_code_size)
{
	PixelShaderPtr ps = nullptr;
	try
	{
		ps = std::make_shared<PixelShader>(shader_byte_code, bye_code_size, this);
	}
	catch (...) {}
	return ps;
}
