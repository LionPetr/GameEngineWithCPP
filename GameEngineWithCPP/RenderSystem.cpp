...
DeviceContext* RenderSystem::getImmidiateDeviceContext()
{
...
VertexShader* RenderSystem::createVertexShader(const void* shader_byte_code, size_t bye_code_size)
{
	VertexShader* vs = nullptr;
	try
	{
		vs = new VertexShader(shader_byte_code, bye_code_size, this);
	}
	catch (...) {}
	return vs;
}
...
PixelShader* RenderSystem::createPixelShader(const void* shader_byte_code, size_t bye_code_size)
{
	PixelShader * ps = nullptr;
	try
	{
		ps = new PixelShader(shader_byte_code, bye_code_size, this);
	}
	catch (...) {}
	return ps;
}
